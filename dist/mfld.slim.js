...
function O(t,e){e?S.profiles={...S.profiles,[e]:t}:S={...S,...t}}function _(t){let e=(t||document.body).querySelectorAll(`[data-${L.join("],[data-")}]${0!=S.fetch?.auto?",a":""}`)||[]
