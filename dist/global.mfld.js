...
for(let o of u)n.match(/bind|sync/)?M(t,p,f,o,n,d):b(t,o,i,f,n.replace(e,""),p,d)}}}}},N={store:(store_name,store_ops)=>(store_ops?.hasOwnProperty("value")||store_ops?.hasOwnProperty("updater")||(store_ops={value:store_ops}),w(store_name,store_ops)),ustore:(store_name,store_ops)=>w(store_name,store_ops),get:store_name=>w(store_name),func:func_name=>i.MFLD.fn[func_name],funcs:funcs=>{for(let e in funcs)i.MFLD.fn[e]=funcs[e]},config:(new_ops,profile_name)=>{return e=new_ops,void((t=profile_name)?_.profiles={..._.profiles,[t]:e}:_={..._,...e})
