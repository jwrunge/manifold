...
for(let[e,i]of r){let n=f(e),r="function"==typeof i?await(i?.(n.value)):i,s=Array.from(n.value||[])?.length!==Array.from(r).length,l=""
...
if(t?.config)try{m(JSON.parse(t?.config))}catch(t){console.warn("Invalid Mfld params",t)}t?.init&&function(t){let e=t?.querySelectorAll(`[data-${b.join("],[data-")}]${0!=g.fetch?.auto?",a":""}`)||[]
...
let g={},b=["bind","sync","fetch"]
function m(t,e){e?g.profiles={...g.profiles,[e]:t}:g={...g,...t}}function M(t,e,o){let i=t
