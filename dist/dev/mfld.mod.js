 ...
 */
t=>{"string"==typeof t&&(t=document.querySelector(t)),function(t){let e=(t||document.body).querySelectorAll(`[data-${h}${["bind","sync","get","head","post","put","delete","patch"].join(`],[data-${h}`)}]${0!=c.fetch?.auto?",a":""}`)||[]
