...
/**!
   ...
   */
t=>{"string"==typeof t&&(t=document.querySelector(t)),function(t){let e=`[data-cu-${b.join("],[data-cu-")}],[cu-${b.join("],[cu-")}]${0!=p.fetch?.auto?",a":""}`,o=(t||document.body).querySelectorAll(e)||[]
