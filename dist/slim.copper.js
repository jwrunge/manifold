...
if(t?.config)try{b(JSON.parse(t?.config))}catch(t){console.warn("Invalid Cu params",t)}t?.init&&function(t){let e=t?.querySelectorAll(`[data-${m.join("],[data-")}]${0!=g.fetch?.auto?",a":""}`)||[]
