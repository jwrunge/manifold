...
a?.length||(a=[""])
for(let o of a){"fetch"==e&&$(t,o,h,d,m),d?.length||(d=[""])
...
t=e?.[e.length-1]||""}return t?.split(p)||[]}function $(t,e,o,n,i){let r=o=>{o?.preventDefault(),o?.stopPropagation()
 ...
 */
(new_ops,profile_name)=>g(new_ops,profile_name),tick:
/**!
