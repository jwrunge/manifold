...
for(let n of f)i.match(/bind|sync/)?F(e,p,u,n,i,d):g(e,n,o,u,i.replace(t,""),p,d)}}}}},E={store:(store_name,store_ops)=>(store_ops?.hasOwnProperty("value")||store_ops?.hasOwnProperty("updater")||(store_ops={value:store_ops}),w(store_name,store_ops)),ustore:(store_name,store_ops)=>w(store_name,store_ops),get:store_name=>w(store_name),func:func_name=>MFLD.fn[func_name],funcs:funcs=>{for(let t in funcs)MFLD.fn[t]=funcs[t]},config:(new_ops,profile_name)=>{return t=new_ops,void((e=profile_name)?x.profiles={...x.profiles,[e]:t}:x={...x,...t})
var t,e},onTick:t=>{var e;(e=t)&&a.push(e)},register:t=>{"string"==typeof t&&(t=document.querySelector(t)),_(t)}}
export{E as Mfld}
