...
return e?n?n.t(t,e):new g(t,e):n||new g(t,e)},m=window
...
e.src=t.src,document.head.appendChild(e)})),a({in:l.querySelector(r||"body"),out:s?document.querySelector(s):e,relation:n,ops:o,done:t=>{D(t)}}))}let y=e.dataset?.[`${t}resolve`],g=i(y||"")?.func
g?.(m),r(e,n,s)}
"$mount"==n?u():e.addEventListener(n,u)}
function b(t,e,n,o=!1){let i=o?"previousElementSibling":"nextElementSibling"
return e?.(t)?t:b((n?.(t)||t)?.[i],e,n,o)}let M=(t,e,o)=>h(n(),{upstream:t,updater:()=>e?.({$el:o,$st:F,$fn:A}),scope:o}),x=(t,e,n)=>{M(n,(()=>e?.({$el:t,$st:F,$fn:A})),t)},S=(t,e,n)=>{let o=e=>{n?.({$el:t,$st:F,$fn:A}),r(t,e)}
"$mount"==e?o():t.addEventListener(e,o)},T=(e,n,o,r,s,l)=>{let f,u,c=document.createElement("template"),$=(t=>{let e="TEMPLATE"
...
return"else"==h?.[0]||1==r?.({$el:t,$st:e,$fn:n})}}f=M([...s,...m],p?u:r,$),$.dataset[`${t}cstore`]=f.name,f.sub((t=>{void 0!==t&&a((()=>{b(c?.nextElementSibling,(t=>t?.classList?.contains(`${n}-end`)),(t=>d(t,"out",l,(()=>t?.remove())))),p&&!t||((t,e)=>{if(t instanceof Map)for(const[n,o]of t.entries())e(n,o)
