...
for(let i of u)o.match(/bind|sync/)?x(t,p,f,i,o,d):w(t,i,n,f,o.replace(e,""),p,d)}}}}},A={store:
/**!
 ...
 */
(new_ops,profile_name)=>{return e=new_ops,void((t=profile_name)?T.profiles={...T.profiles,[t]:e}:T={...T,...e})
var e,t},onTick:
/**!
