...
var t,e},onTick:t=>{var o;(o=t)&&e.push(o)},register:t=>{"string"==typeof t&&(t=document.querySelector(t)),function(t){let e=(t||document.body).querySelectorAll(`[data-${b.join("],[data-")}]${0!=p.fetch?.auto?",a":""}`)||[]
