...
return t?.(e)?e:b((i?.(e)||e)?.[o],t,i,n)}let M=(e=[],t)=>y(n(),{upstream:[...e],updater:e=>{try{return t?.func?.(...e)??e[0]}catch(e){return}},scope:t?.observeEl}),x=(e,t,i,n,r,s)=>{if(r.match("bind"))M(t,{observeEl:e,func:()=>{let r=s?.(...t.map((e=>o.MFLD.st.get(e)?.value||o?.[r]||[])),e)
...
"$mount"==n?o():e.addEventListener(n,o)}},E=(t,i,n,o,r,l)=>{let a,f,c=document.createElement("template"),d=(e=>{let t="TEMPLATE"
...
i?.innerHTML&&(i.innerHTML=r)}for(let t of i.content.children)t?.innerHTML||(t.innerHTML=e),d.before(t),h(t,"in",l,(()=>_(t)))}))}))}))},T={},S=["bind","sync","templ","if","elseif","else","each","get","head","post","put","delete","patch"].map((t=>`${e}${t}`))
...
if(c&&!d&&console.warn(`"${c}" not registered`,t),o.match(/each|templ|if|else/))E(t,o,h||[],d,p||[],n)
else{u?.length||(u=[""])
for(let i of u)o.match(/bind|sync/)?x(t,p,f,i,o,d):w(t,i,n,f,o.replace(e,""),p,d)}}}}},A={store:(store_name,store_ops)=>(store_ops?.hasOwnProperty("value")||store_ops?.hasOwnProperty("updater")||(store_ops={value:store_ops}),y(store_name,store_ops)),ustore:(store_name,store_ops)=>y(store_name,store_ops),get:store_name=>y(store_name),func:func_name=>o.MFLD.fn[func_name],funcs:funcs=>{for(let e in funcs)o.MFLD.fn[e]=funcs[e]},config:(new_ops,profile_name)=>{return e=new_ops,void((t=profile_name)?T.profiles={...T.profiles,[t]:e}:T={...T,...e})
var e,t},onTick:e=>{var t;(t=e)&&f.push(t)},register:e=>{"string"==typeof e&&(e=document.querySelector(e)),_(e)}}
export{A as Mfld}
