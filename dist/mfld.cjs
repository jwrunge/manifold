...
for(let n of u)i.match(/bind|sync/)?E(e,d,f,n,i,p):v(e,n,o,f,i.replace(t,""),d,p)}}}}}globalThis.addEventListener("popstate",(t=>{}))
let N={store:(store_name,store_ops)=>(store_ops?.hasOwnProperty("value")||store_ops?.hasOwnProperty("updater")||(store_ops={value:store_ops}),y(store_name,store_ops)),ustore:(store_name,store_ops)=>y(store_name,store_ops),get:store_name=>y(store_name),func:func_name=>MfFn[func_name],funcs:funcs=>{for(let t in funcs)MfFn[t]=funcs[t]},config:(new_ops,profile_name)=>{return t=new_ops,void((e=profile_name)?A.profiles={...A.profiles,[e]:t}:A={...A,...t})
var t,e},onTick:t=>{var e;(e=t)&&f.push(e)},register:t=>{"string"==typeof t&&(t=document.querySelector(t)),O(t)}}
exports.Mfld=N
