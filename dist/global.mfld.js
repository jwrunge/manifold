...
let S={store:(store_name,store_ops)=>(store_ops?.hasOwnProperty("value")||store_ops?.hasOwnProperty("updater")||(store_ops={value:store_ops}),g(store_name,store_ops)),ustore:(store_name,store_ops)=>g(store_name,store_ops),get:store_name=>g(store_name),func:func_name=>i.MFLD.fn[func_name],funcs:funcs=>{for(let e in funcs)i.MFLD.fn[e]=funcs[e]},config:(new_ops,profile_name)=>{return e=new_ops,void((t=profile_name)?E.profiles={...E.profiles,[t]:e}:E={...E,...e})
var e,t},onTick:e=>{var t;(t=e)&&f.push(t)},register:i=>{"string"==typeof i&&(i=document.querySelector(i)),(i=>{if(i?.nodeType==Node.TEXT_NODE)return
