...
for(let i of u)n.match(/bind|sync/)?L(t,p,f,i,n,d):w(t,i,o,f,n.replace(e,""),p,d)}}}}},E={store:
/**!
 ...
 */
(new_ops,profile_name)=>{return e=new_ops,void((t=profile_name)?x.profiles={...x.profiles,[t]:e}:x={...x,...e})
var e,t},onTick:
/**!
 ...
 */
e=>{"string"==typeof e&&(e=document.querySelector(e)),F(e)}}
